...
from export_csv import ALLOWED_TABLES

AUTO_SKIP_COLS = {"id", "created_at", "create_at"}
def get_table_columms(cur, table: str) -> set[str]:
...
def import_table_from_csv(table: str, csv_path: Path, truncate_first: bool = False):
    ...
    try:
        table_cols = get_table_columms(cur, table)
...
if __name__ == "__main__":
    ...
    path = input("CSV path (ex: exports/retete.csv): ").strip()
